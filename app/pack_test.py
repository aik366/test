...
button1 = ctk.CTkButton(frame1, text="pack_forget_3", command=pack_forget_3)
button1.pack(padx=20, pady=20)

button1_1 = ctk.CTkButton(frame1, text="pack_forget_2", command=pack_forget_2)
button1_1.pack(padx=20, pady=20)

button1_2 = ctk.CTkButton(frame1, text="pack_3", command=pack_3)
button1_2.pack(padx=20, pady=20)

button1_3 = ctk.CTkButton(frame1, text="pack_2", command=pack_2)
button1_3.pack(padx=20, pady=20)

frame2 = ctk.CTkFrame(app, fg_color="green", width=400, height=400)
frame2.pack(side="left", padx=10, pady=10, fill="both", expand=True)
button2 = ctk.CTkButton(frame2, text="Button 2", command=pack_3)
